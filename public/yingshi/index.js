...
var app = new Vue({
  ...
  data: function () {
    return {
      appKey:'b2f3ff61c22d44148bf6304a649e6227',
      ezvizToken: 'at.9m8zm9pidur10cedbbsi63tvcchq1rrl-8399xgli8a-1mr0ktv-djtvvpkjo',
      deviceSerial:'F88771959',
      channelNo: '1',	    
	  deviceClass:'0',
	  platformId:'',
      startTime: '',
          ...
          arguments: encodeURI(
            JSON.stringify({
              response: {
                ...
                message: null,
                data: {
					layout:str //参数int为布局编号，其定义参见控件初始化函数 init方法中指定的编号。
				}
              },
            })
          ),
