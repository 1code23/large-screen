    ...
    tooltip: {
      ...
      formatter: (params) => {
        if (params.seriesName !== "mouseoutSeries" && params.seriesName !== "pie2d") {
          ...
          return `<span style="display:inline-block;margin-right:5px;border-radius:0;width:12px;height:12px;background-color:${params.color};"></span>` + `${params.seriesName}<br/>` + `${bfb}%`;
        }
      },
    },
    xAxis3D: {
